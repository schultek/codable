# Serialization Protocol for Dart
...
👉 **Read the RFC:** [RFC: Serialization Protocol for Dart](https://github.com/schultek/codable/blob/main/docs/rfc.md)
...
First, just **[read the RFC](https://github.com/schultek/codable/blob/main/docs/rfc.md)** and give feedback by commenting on the [issue](TODO) or the [forum post](TODO).
