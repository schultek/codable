...
augment class Measures implements SelfEncodable {
  const Measures(this.id, this.name, this.age, this.isActive, this.signupDate, this.website);
...
// equatable augmentation
augment class Measures {
  @override
